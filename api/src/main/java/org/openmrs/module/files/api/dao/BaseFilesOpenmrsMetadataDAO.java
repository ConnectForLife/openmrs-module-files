...
/**
 * The base class for OpenMRS Metadata object DAOs in Files module.
 *
 * @param <E> the main type handled by the DAO
 */
abstract class BaseFilesOpenmrsMetadataDAO<E extends OpenmrsMetadata>
    extends BaseFilesOpenmrsObjectDAO<E> {

  /** @param openmrsObjectClass the Class of the main type handled by the Dao, not null */
  BaseFilesOpenmrsMetadataDAO(final Class<E> openmrsObjectClass) {
